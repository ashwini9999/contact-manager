      ...
      <ScrollView style={styles.container}>
        ...
        <Card style={styles.actionContainer}>
          <CardItem style={styles.actionButton} bordered>
            ...
            >
              <Entypo name="message" size={50} color="#019031" />
            </TouchableOpacity>
          </CardItem>
          ...
          <CardItem style={styles.actionButton} bordered>
            ...
            >
              <Entypo name="phone" size={50} color="#019031" />
            </TouchableOpacity>
          </CardItem>
        </Card>
        ...
        <Card style={styles.actionContainer}>
          <CardItem style={styles.actionButton} bordered>
            ...
            >
              <Entypo name="edit" size={50} color="#019031" />
          ...
          <CardItem style={styles.actionButton} bordered>
            ...
            >
              <Entypo name="trash" size={50} color="#019031" />
            </TouchableOpacity>
          </CardItem>
        </Card>
      </ScrollView>
